...
class Upload_exam_paper : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        selectpdftextview.setOnClickListener { view ->
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE)
                ...
                Constants.showPdfChooser(this@Upload_exam_paper)
            } else {
    ...
    private fun uploadExamPaper(){
        ...
        FirestoreClass().uploadexampaper(this@Upload_exam_paper, Exam_paper)
    }
    ...
    private fun uploadExamPaperPdf(){
        ...
        val sRef: StorageReference = FirebaseStorage.getInstance().reference.child(
            "EXAM_PAPER_PDF" + System.currentTimeMillis()
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == Constants.READ_STORAGE_PERMISSION_CODE) {
            ...
            if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                Constants.showImageChooser(this@Upload_exam_paper)
            } else {
    ...
    fun setSpinners(){
        val branches = arrayOf("Select Branch of exam", "CSE", "AIDS", "ECE", "MECH")
