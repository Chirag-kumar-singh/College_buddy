...
open class NotesPaperItemsAdapter(private val context: Context,
                                 private val list: ArrayList<Notes_paper>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return MyViewHolder(LayoutInflater.from(context)
            .inflate(R.layout.item_notes_paper, parent, false))
    ...
    interface OnClickListener{
        fun onClick(position: Int, model: Notes_paper)
    }
